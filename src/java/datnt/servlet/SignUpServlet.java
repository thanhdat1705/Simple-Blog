...
public class SignUpServlet extends HttpServlet {
    ...
    private final String SIGNUP_ERROR = "signUpPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = (String) siteMap.get(SIGNUP_ERROR);
        ...
        try {
            ...
            if (!dao.checkExisted(email)) {
                int result = dao.createAccount(email, password, name, role, status);
                if (result > 0) {
                    ...
                    LOGGER.info("Sign up succ");
                }

            } else {
                request.setAttribute("IS_DUP_EMAIL", "This email is existed!!!");
                LOGGER.warn("Email is existed");
            }
